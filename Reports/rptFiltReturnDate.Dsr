VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptFiltReturnDate 
   Caption         =   "Print Book Return by Date"
   ClientHeight    =   5490
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   11325
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "PRINT BOOK RETURNED BY DATE"
         CanGrow         =   -1  'True
         Alignment       =   2
      EndProperty
      ItemType2       =   7
      BeginProperty Item2 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   2445
         Object.Height          =   1875
         Picture         =   "rptFiltReturnDate.dsx":0000
      EndProperty
      ItemType3       =   3
   ...
   EndProperty
End
Attribute VB_Name = "rptFiltReturnDate"
